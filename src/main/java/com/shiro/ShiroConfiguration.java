...
import com.filter.URLPathMatchingFilter;
import com.realm.DatabaseRealm;
...
public class ShiroConfiguration {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager){
        ...
        filterChainDefinitionMap.put("/travellist", "anon");
        filterChainDefinitionMap.put("/Route", "anon");
        filterChainDefinitionMap.put("/Other", "anon");
        
        filterChainDefinitionMap.put("/static/**", "anon");
        filterChainDefinitionMap.put("/assets/**", "anon");
        filterChainDefinitionMap.put("/assetslogin/**", "anon");
        filterChainDefinitionMap.put("/bootstrap/**", "anon");
        filterChainDefinitionMap.put("/jquery-3.4.1.min.js", "anon");
        filterChainDefinitionMap.put("/test/**", "anon");
        filterChainDefinitionMap.put("/config/**", "anon");
        filterChainDefinitionMap.put("/config/addUser", "anon");
